...
double det1 = result1[1]*result3[1] - result2[1]*result2[1];
	...
	cout << "RADII:" << endl;
	cout << 0.5*result3[0]/det0 << "     " << -0.5*result2[0]/det0 << endl;		//Cbar
	cout << -0.5*result2[0]/det0 << "     " << 0.5*result1[0]/det0 << endl;		//Cbar
cout << endl;
	cout << 0.5*result3[1]/det1 << "     " << -0.5*result2[1]/det1 << endl;		//Cavgd
	cout << -0.5*result2[1]/det1 << "     " << 0.5*result1[1]/det1 << endl;		//Cavgd
...
//vector<double> exactresult(3);
//exactresult = get_source_variances(&my_model_params);
//cout << "exactresult[0] = " << exactresult[0] << endl
//     << "exactresult[1] = " << exactresult[1] << endl
//     << "exactresult[2] = " << exactresult[2] << endl;
...
//vector<double> EAexactresult(3);
//EAexactresult = get_EAsource_variances(&my_model_params);
//cout << "EAexactresult[0] = " << EAexactresult[0] << endl
//     << "EAexactresult[1] = " << EAexactresult[1] << endl
//     << "EAexactresult[2] = " << EAexactresult[2] << endl;
	...
	for (int i=0; i<nq_points1*nq_points2; i++)
		{
			...
			if (dim >= 2) (*q_vec_ptr).at(i).qcoord2 = q2_lower + double(i / nq_points2)*q2_interval;
		}
	}
	else if (program_function == 1 || program_function == 2) {
